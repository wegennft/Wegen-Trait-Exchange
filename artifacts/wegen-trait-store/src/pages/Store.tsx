...
export function Store() {
  ...
  const { items: cartItemsMap, addItem, removeItem, clearCart, hasItem, count: cartCount, totalUsd: cartTotalUsd, totalEth: cartTotal, cartOpen, openCart, closeCart } = useCart();
