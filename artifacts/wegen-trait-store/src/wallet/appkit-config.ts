...
const configuredProjectId = import.meta.env.VITE_WALLETCONNECT_PROJECT_ID as string | undefined;
/** Reown demo project ID — localhost / unset env only; replace with your own for production. */
