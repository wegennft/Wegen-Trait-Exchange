> **Status (2026-08-21):** Landed on `cursor/finish-wallet-connect-c3f1` — EVM injected wallets + EIP-6963 + Reown WalletConnect + checksummed SIWE. Solana connect UI removed (EVM-only). Set `VITE_WALLETCONNECT_PROJECT_ID` for production.
